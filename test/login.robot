...
TC1
    ...
    common.Login User    qwerwqr    qwerwqer
    ${err}    common.Check Error Msg
...
TC2
    ...
    ...    Insert No username
    common.Element is Visible    ${login_logo}
    common.Login User    ${EMPTY}    ${password}
    ${err}    common.Check Error Msg
...
TC3
    ...
    ...    Insert No password
    common.Element is Visible    ${login_logo}
    common.Login User    ${username['std']}    ${EMPTY}
    ${err}    common.Check Error Msg
...
TC4
    ...
    common.Element is Visible    ${login_logo}
    common.Login User    ${username['lck']}    ${password}
    ${err}    common.Check Error Msg
...
TC6
    ...
    common.Element is Visible    ${login_logo}
    common.Login User    ${username['prb']}    ${password}
    Take Screenshot    EMBED
    common.Logout
    Sleep    5